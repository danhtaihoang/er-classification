...
def compare_inference(X,y,train_size):
    ...
    return acc.mean(axis=0),acc.std(),roc_auc.mean(),roc_auc.std(),precision.mean(),\
        precision.std(),recall.mean(),recall.std(),cost.mean(),cost.std(),
#-------------------------------------------------------------------------------------------------
list_train_size = [0.3,0.2,0.1]
